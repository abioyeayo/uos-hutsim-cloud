...
<html>
   ...
   <body>
     <div style="max-width: 960px; text-align: center; border: solid 1px black; margin-left: auto; margin-right: auto; padding: 20px; margin-top: 20px;"> 
         ...
         ?> 
         <br>
         <h2>HARIS simulator started</h2>
         <br>
         <form action="stop_haris.php" method="post">
            <input type="hidden" name="stopped_pid" value="<?php echo $output[0]; ?>">
            <div class="buttons">
               <div class="action_btn">
                  <button class="action_btn" type="button"><a href='<?php echo $base_url . $port; ?>/preset/scenario?file-name=DynamicTaskingShift.json' target='_blank' style='text-decoration:none; color: inherit;'>Go to Simulator</a></button>
                  <button class="action_btn" type="submit" value="Stop HutSim">Stop HARIS</button>
               </div>
            </div>
         </form>
         <br>
