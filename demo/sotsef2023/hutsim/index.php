...
<html>
    ...
    <body>
        <div style="text-align: right; max-width: 960px; margin-right: auto; margin-left: auto; padding-bottom: 10px; padding-top: 10px;">
            <a href="/demo/sotsef2023/">Home</a> |
            <a href="/demo/sotsef2023/leaderboard.php">Leaderboard</a>
        </div>
