...
<div class="col-lg-8 mx-auto p-4 py-md-5">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a href="publications.php" class="nav-link active" aria-current="page">Publications</a></li>
    ...
    <main>
        <h1 class="text-body-emphasis">Publications</h1>
        <p class="fs-5 col-md-8">Below is a collection of our recent work. </p>
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="card shadow-sm">
                        <div class="row g-0">
                            <div class="col-md-12">
                                <img src="team/mohammad_images/ms_1.png" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-12">
