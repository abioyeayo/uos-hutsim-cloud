<?php
  ...
  if ($group_id == "CLALM"){ 
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $radio_pcpt_p10 = $_POST['radio_pcpt_p10'];
        $radio_pcpt_p11 = $_POST['radio_pcpt_p11'];
        ...
        $radio_pcpt_p17 = $_POST['radio_pcpt_p17'];
        $radio_pcpt_p18 = $_POST['radio_pcpt_p18'];
        $radio_pcpt_p19 = $_POST['radio_pcpt_p19'];
        $radio_pcpt_p20 = $_POST['radio_pcpt_p20'];
          ...
          <div class="step">
              ...
              <div class="mx-0 mx-sm-auto mb-4">
                <div class="card">
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p2_question" class="my-3 fw-bold">The swarm's behaviour seemed trustworthy to you. </p>
                            <div class="form-check mb-2">
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p8_question" class="my-3 fw-bold">Generally, you trust autonomous systems more than human-operated systems.</p>
                            <div class="form-check mb-2">
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p9_question" class="my-3 fw-bold">Generally, you trust human-operated systems more than autonomous systems.</p>
                            <div class="form-check mb-2">
                   ...
                   <div class="px-4">
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p12_question" class="my-3 fw-bold">You trust an autonomous swarm to make ethical decisions on its own.</p>
                            <div class="form-check mb-2">
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p13_question" class="my-3 fw-bold">You trust a human or autonomous system to make decisions in a critical situation.</p>
                            <<div class="form-check mb-2">
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p15_question" class="my-3 fw-bold">You trust an autonomous system that detects casualties faster but might be wrong in certain classifications or a human-operated system 
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p19_question" class="my-3 fw-bold">If the autonomous swarm makes an error while detecting casualties, you will trust it again.</p>
                            <div class="form-check mb-2">
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p21_question" class="my-3 fw-bold">I would trust the autonomous systems if the swarm provided clear explanation of its intentions and actions in comparison to human-operated swarm.</p>
                            <div class="form-check mb-2">
                    ...
                    <div class="px-4">
                        <div style="font-size: 0.95rem;">
                            <p id="radio_pcpt_p22_question" class="my-3 fw-bold">I would trust an autonomous swarm more in low-risk missions as compared to high-risk missions where I would prefer human-operated missions more.</p>
                            <div class="form-check mb-2">
