                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="px-4 text-center">
                      ...
                      <!-- Physical Demand -->
                      <p id="radio_wsga_pd_question" class="text-center"><strong>How physically demanding was the task?</strong></p>
                      <div class="form-check form-check-inline mb-2">
      ...
      var currentTab = 0; // Current tab is set to be the first tab (0)
        ...
        function validateForm() {
          ...
          if(radio_wsga_pd != null) {
            ...
            // radio_wsga_pd_11.ClassName -= "is-invalid";
            // radio_wsga_pd_11.value = "11";
            ...
            // radio_wsga_pd_11.classList.add("is-valid");
            // radio_wsga_pd_1.value = "";
            // radio_wsga_pd_11.value = "";
            for (i=0; i<radio_wsga_pd_elements.length;i++){
