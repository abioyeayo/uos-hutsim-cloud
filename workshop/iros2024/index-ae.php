...
<div class="col-lg-10 col-xl-9 col-xxl-8 mx-auto p-4 py-md-5">
    ...
    <div class="row g-md-3">
      ...
      <div class="col-12">
        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-sm-4 col-md-3">
              <div class="card shadow-sm">
                  <img class="bd-placeholder-img card-img-top" width="100%" src="Portraits/PH.png" role="img" aria-label="Placeholder: Thumbnail" />
          ...
          <div class="col-12 col-sm-4 col-md-3">
              <div class="card shadow-sm">
                  ...
                  <div class="card-body">
                      <p class="card-text"><strong>Ayomide Agunloye</strong><br>University of Southampton</p>
                  </div>
              </div>
          </div>
        </div>
      ...
      <div class="col-12">
          <h4 class="mt-5">Affiliations</h4>
          <!-- <div class="my-4 border-top"></div> -->
          <div>
            <img src="logos/B09-university-of-southampton-logo.png" class="rounded float-left me-5" width="200" alt="University of Southampton Logo">
            <img src="logos/nottingham-logo.png" class="rounded float-left me-5" width="200" alt="University of Nottingham Logo">
            <img src="logos/B09-bournemouth-university-logo.png" class="rounded float-left me-5" width="200" alt="Bournemouth University Logo">
  ...
  <footer class="pt-3 my-3 text-body-secondary border-top">
